...
<br><br>
<?php
                        echo "<a class='btn btn-info btn-lg' href='../vistas_instrumentos/read.php?id=" . encode($instrumento->getid()) . "' title='add' data-toggle='tooltip'>Añadir<span class='glyphicon glyphicon-shopping-cart'></span></a>";
                        echo "<a class='btn btn-info btn-lg' href='../vistas_instrumentos/read.php?id=" . encode($instrumento->getid()) . "' title='info' data-toggle='tooltip'>Detalles<span class='glyphicon glyphicon-list-alt'></span></a>";
?>
					</div>
				</form>
                </div>
